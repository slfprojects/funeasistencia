...
<div class="content-wrapper">
	...
	<input type="hidden" name="mt_tasa_dia" value="0">
	<!-- Content -->
	<div class="container-xxl flex-grow-1 container-p-y">
		<div class="col-md-12 mb-3">
			...
			<c:import url="/WEB-INF/jsp//templates/aperturaTarjeta.jsp"></c:import>
				...
				<hr>
				<div style="text-align:left;"><span class="badge bg-dark col-md-12">Datos del Presupuesto</span></div>
				<hr>
				<c:import url="/WEB-INF/jsp/templates/FormulariosBasicos2.jsp"></c:import>
				<button onclick="fnAgregarObjetos()" class="btn btn-dark">
					Generar 
				</button>
				 <hr>
				...
				<hr>
				<center>
				<button onclick="fnAgregarPresupuestos()" class="btn btn-dark" >
					Activar Presupuesto
				</button>
