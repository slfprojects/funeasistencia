        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="/front.funeasistencia/autenticar" method="POST">
                <div class="mb-3">
              ...
              <p class="text-center">
                <span>¿Desea Recuperar su contraseña?</span>
                <a href="/front.funeasistencia/recuperarclave.indice">
                  <span>Clíc aquí</span>
                </a>
              </p>
              ...
              <p class="text-center">
                ...
                <a href="/front.funeasistencia/descargarapp">
                  <span>Clíc aquí</span>
                </a>
              </p>
            </div>
