...
<div class="content-wrapper">
	...
	<c:set var="vLinkEliminar" value="${requestScope.linkEliminar}"></c:set>
	<c:set var="vIdPojo" value="${requestScope.idPojo}"></c:set>
	<c:set var="vNombreFormulario" value="${requestScope.nombreFormulario}"></c:set>
	<c:set var="vLinkActualizar" value="${requestScope.linkActualizar}"></c:set>
	...
	<input type="hidden" name="linkEliminar" value="${vLinkEliminar}">
	<input type="hidden" name="linkActualizar" value="${vLinkActualizar}">
