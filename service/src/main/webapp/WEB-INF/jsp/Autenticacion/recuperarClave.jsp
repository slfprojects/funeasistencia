        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="/front.funeasistencia/recuperarclave.gestion" method="POST">
                <div class="mb-3">
                  <div class="form-floating">
                    ...
                    autocomplete="off"
                    name="txcorreo">
                    <label for="floatingInput">Correo del Usuario</label>
                  </div>
                </div>
                <div class="mb-3">
                  <div class="form-floating">
                ...
                <div class="mb-3">
                  <button class="btn btn-dark d-grid w-100" type="submit">Recuperar Clave</button>
                </div>
              </form>
            </div>
          </div>
